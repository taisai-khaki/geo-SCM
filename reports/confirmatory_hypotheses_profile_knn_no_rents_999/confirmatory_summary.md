...
- GPR column used: `gpr_profile_knn_annual`.
- Main controls include rents: `False`.
...
- H4: NOT_SUPPORTED | raw sig=0, FDR sig=0, pretrend_pass=1, placebo_pass=0
- H5: NOT_SUPPORTED | raw sig=0, FDR sig=0, pretrend_pass=1, placebo_pass=0
